# pi-coding-agent 0.85.1 包定义（覆盖 nixpkgs 锁定的旧版本 0.82.1）。
# 内容与 NixOS/nixpkgs@nixos-unstable 的
# pkgs/by-name/pi/pi-coding-agent/package.nix 保持一致；升级版本时同步替换
# version/src.hash/npmDepsHash/modelData.hash 四者并核对 buildPhase 的 workspace 列表。
{
  lib,
  buildNpmPackage,
  fetchFromGitHub,
